...
#SBATCH --array=0-4999  # Adjust the array size accordingly

module load gcc/9.3.0 python/3.11.2

# Calculate the total number of simulations
total_simulations=10000 # n simulations per task, starting from ID 0

# Calculate the number of simulations per task
simulations_per_task=2
...
do
    python Plant_Insect_Full.py -i $start_id
done
